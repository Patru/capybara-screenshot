...
describe "Using Capybara::Screenshot with MiniTest::Spec" do
  include CommonSetup
  ...
  it 'saves a screenshot on failure' do
    run_failing_case <<-RUBY
      class TestFailure < Minitest::Spec
        include Capybara::DSL
        include Capybara::Screenshot::MinitestPlugin

        def test_failure
          visit '/'
          page.body.must_include('This is the root page')
  ...
  it "does not save a screenshot for tests that don't include the MinitestPlugin" do
    run_failing_case <<-RUBY
      class TestFailure < MiniTest::Spec
        include Capybara::DSL
      ...
      class TestFailure < Minitest::Spec
        ...
        def test_failure
          ...
          using_session :different_session do
            ...
            page.body.must_include 'This is a different page'
            click_on "you'll never find me"
          end
        end
      end
